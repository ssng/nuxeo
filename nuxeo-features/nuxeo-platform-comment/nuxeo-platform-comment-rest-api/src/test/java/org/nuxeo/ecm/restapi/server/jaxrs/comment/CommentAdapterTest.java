...
public class CommentAdapterTest extends BaseTest {
    ...
    @Test
    public void testGetCommentsForUnexistingDocument() {
        try (CloseableClientResponse response = getResponse(RequestType.GET, "id/unexistingDocId/@comment",
    ...
    @Test
    public void testGetCommentWithUnexistingId() {
        DocumentModel file = session.createDocumentModel("/testDomain", "testDoc", "File");
        file = session.createDocument(file);
        fetchInvalidations();

        try (CloseableClientResponse response = getResponse(RequestType.GET,
                "id/" + file.getId() + "/@comment/" + "unexistingId")) {
            assertEquals(Response.Status.NOT_FOUND.getStatusCode(), response.getStatus());
        }
    }
    ...
    @Test
    public void testDeleteCommentWithUnexistingId() {
        DocumentModel file = session.createDocumentModel("/testDomain", "testDoc", "File");
        file = session.createDocument(file);
        fetchInvalidations();
